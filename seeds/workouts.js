  ...
  return knex('workouts').del()
    .then(function () {
      ...
      return knex('workouts').insert([
        ...
        {id: 68, workout: 'Pushamid-4.0', description: 'Run for desire duration. E5MOM do 5 push-ups. Add 5 push-ups each time. Once unable to do the push-ups unbroken, run 10 min, then E5M0M back down to 0', type: 'OCR', time: '>60 min'},
        {id: 69, workout: 'Hawaiian-4.0', description: 'Run for desire duration. Every km, 10 push ups, 10 burpees, 5 pull ups, 10 squats. Add 5 push-ups each time.', type: 'OCR', time: '>60 min'},
        ...
        {id: 71, workout: "Cwy's Special - Bonus", description: '10 min warm up, 50 min AMRAP: 100 m hill sprint - sandbag/bucket carry up the hill - 10 pull ups - 10 push ups - 100 m hill sprint - 10 sandbag/bucket squats - 250 m race pace run - 10 squat jumps - 15 burpees. Finisher: 3x 10 toes2bar - deadhang to failure - 2 min plank', type: 'OCR', time: '>60 min'},
        {id: 72, workout: "Cwy's Special - Bonus(box)", description: '10 min warm up, 50 min AMRAP: 100 m hill sprint - sandbag/bucket carry up the hill - 10 pull ups - 10 push ups - 100 m hill sprint - 10 sandbag/bucket squats - 250 m race pace run - 10 box jumps - 15 burpees. Finisher: 3x 10 toes2bar - deadhang to failure - 2 min plank', type: 'OCR', time: '>60 min'},
